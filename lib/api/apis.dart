      ...
      var res = await post(Uri.parse('https://fcm.googleapis.com/fcm/send'),
          headers: {
            ...
            HttpHeaders.authorizationHeader:
                'key=AAAAOI-FRSs:APA91bF471EQRSdC4gCFH5QzsVLvl9KsR-tpWw79Fo98rkUCx42OJaOct2-U-2wtIizit72-LZ89aCNNkarXEPV5fNgKJ464XS7o8SMIuncHWguUFm03QI-tokK4ipIfIoD1nNcFvIgz'
          },
...
//   //for getting firebase messagning (push Notification)
//   static Future<void> getFirebaseMessagingToken() async {
//     await fMessaging.requestPermission();
...
//   //for adding an chat for our conversation
//   static Future<bool> addChatUser(String email) async {
//     final data = await firestore
//         .collection('users')
//         .where('email', isEqualTo: email)
...
//         name: user.displayName.toString(),
//         email: user.email.toString(),
//         about: "Hey I'm Using Yaree Chat App!",
//         image: user.photoURL.toString(),
//         createdAt: time,
//         isOnline: false,
//         lastActive: time,
...
//   //update profile picture od user
//   static Future<void> updateProfilePicture(File file) async {
//     //getting image file extension
//     final ext = file.path.split('.').last;
//     log('Extension: $ext');
...
//   //for getting all message of a spacific conversation from firestore database
//   static Stream<QuerySnapshot<Map<String, dynamic>>> getAllMessages(
//       ChatUser user) {
//     return firestore
//         .collection('chats/${getConversationID(user.id)}/messages/')
...
//   //get only last message of spacific chat
